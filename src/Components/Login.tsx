            ...
            <div className='w-full max-w-screen-xl flex flex-row gap-4'>
                ...
                <div className='h-[95vh] flex flex-col justify-center items-center w-full'>
                    ...
                    <div className='flex flex-col gap-2 mt-6 w-full max-w-md'>
                        <input type="email" placeholder='Email' className='w-full bg-[#27272A] p-2 rounded-md border border-[#3F3F46] text-white' />
                        <input type="password" placeholder='Password' className='w-full bg-[#27272A] p-2 rounded-md border border-[#3F3F46] text-white' />
                        <button className='bg-[#3F3F46] p-2 rounded-md text-white'>Login</button>
                    ...
                    <div>
                        ...
                        <div className='flex justify-center gap-2 mt-2'>
                            <button className='bg-[#3F3F46] p-2 rounded-md text-white w-24'>Google</button>
                            <button className='bg-[#3F3F46] p-2 rounded-md text-white w-24'>Facebook</button>
                        </div>
                    </div>
                </div>
            </div>
